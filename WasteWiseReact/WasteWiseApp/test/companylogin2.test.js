...
import CompanyLogin2 from '../app/logins/companylogin2';
  ...
  Promise.resolve({
    ...
    json: () =>
      Promise.resolve([
        ...
        { companyUsername: 'testUser', password: 'password' },
      ]),
  })
);

describe('<CompanyLogin2 />', () => {
  it('renders correctly', () => {
    const { getByPlaceholderText, getByText } = render(<CompanyLogin2 />);
  ...
  it('logs in with correct username and password', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith('https://waste-wise-api-sdgp.koyeb.app/api/companyUsers');
  });
